describe("Testing the Settings Bill function", function() {
    ...
    describe("Testing using warning and critical levels", function() {
        ...
        it("it should return a class name of 'critical' when the total cost is more than the critical level set", function() {
            let billSettings = settingsBill();
            ...
            assert.equal("critical", billSettings.totalClassName())
        })
